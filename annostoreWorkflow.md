...
- Accession:
In this workflow, the title, authors, abstract, keywords, PIDs (DOI, ISSN, etc.), journal, publication date (year), and copyrights are added. 
The OCR is captured normally, and we only need to edit typographical errors or accents.

- Treatments:
In this workflow, treatments and subSubSections are added, the latter being divided into nomenclature and multiple. 
...
- Taxonomic names:
In this workflow, the taxonomic names of the target taxa of each treatment are added. 
